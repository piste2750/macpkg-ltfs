...
struct supported_device *supported_devices[] = {
		...
		DEVICE( IBM_VENDOR_ID, "ULTRIUM-TD7     ", IBM_3580, DRIVE_LTO7,    " [ULTRIUM-TD7] " ), /* IBM Ultrium Gen 7 */
		DEVICE( IBM_VENDOR_ID, "ULT3580-TD7     ", IBM_3580, DRIVE_LTO7,    " [ULT3580-TD7] " ), /* IBM Ultrium Gen 7 */
		DEVICE( IBM_VENDOR_ID, "ULTRIUM-HH7     ", IBM_3580, DRIVE_LTO7_HH, " [ULTRIUM-HH7] " ), /* IBM Ultrium Gen 7 Half-High */
		DEVICE( IBM_VENDOR_ID, "ULT3580-HH7     ", IBM_3580, DRIVE_LTO7_HH, " [ULT3580-HH7] " ), /* IBM Ultrium Gen 7 Half-High */
		DEVICE( IBM_VENDOR_ID, "HH LTO Gen 7    ", IBM_3580, DRIVE_LTO7_HH, " [HH LTO Gen 7]" ), /* IBM Ultrium Gen 7 Half-High */
